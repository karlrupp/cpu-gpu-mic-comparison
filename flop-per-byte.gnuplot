...
set label "HD 7970 GHz Ed." at 2012.2,12 center rotate by 00 textcolor rgb "#971c00"
set label "HD 8970"         at 2013,13.1 center rotate by 00 textcolor rgb "#971c00"
set label "FirePro W9100"   at 2014,14 center rotate by 00 textcolor rgb "#971c00"
set label "FirePro S9150"   at 2015,14 center rotate by 30 textcolor rgb "#971c00"

# Labels Intel
set label "X5482"      at 2007,3.5 center rotate by 30 textcolor rgb "#005197"
...
set label "GTX 280"        at 2008,5.5  center rotate by 00 textcolor rgb "#00D317"
set label "GTX 285"        at 2009,5.5  center rotate by 00 textcolor rgb "#00D317"
set label "GTX 580"        at 2010,7 center rotate by 00 textcolor rgb "#00D317"
set label "GTX 580"        at 2011,7 center rotate by 00 textcolor rgb "#00D317"
set label "GTX 680"        at 2012,18 center rotate by 00 textcolor rgb "#00D317"
...
# Labels Xeon Phi
set label "Xeon Phi 7120 (KNC)" at 2014,9 center rotate by 00
set label "Xeon Phi 7290 (KNL)" at 2016,12 center rotate by 30


plot 'data-intel.txt'     using 1:($2/$5)           with linesp pt  9 ps 3.0 title "Xeon CPUs, Intel", \
     'data-sp-nvidia.txt' using 1:($2/$4)           with linesp pt  5 ps 3.0 title "Geforce GPUs, NVIDIA", \
     'data-amd.txt'       using 1:($2/$5)           with linesp pt  7 ps 3.0 title "Radeon GPUs, AMD", \
     'data-intel-phi.txt' using 1:($2/$5)           with linesp pt 11 ps 3.0 title "Xeon Phis, Intel"
...
set label "FirePro S9150"   at 2015,12 center rotate by 30 textcolor rgb "#971c00"
...
set label "E5-2699 v3" at 2015,14  center rotate by 30 textcolor rgb "#005197"
...
set label "Tesla P100"   at 2016,5 center rotate by 30 textcolor rgb "#00D317"

# Labels Xeon Phi
set label "Xeon Phi 7120 (KNC)" at 2014,6 center rotate by 00
set label "Xeon Phi 7290 (KNL)" at 2015.8,7.5 center rotate by 25



plot 'data-intel.txt'     using 1:($3/$5) with linesp pt 9 ps 3.0 title "Xeon CPUs, Intel", \
     'data-dp-nvidia.txt' using 1:($2/$4) with linesp pt 5 ps 3.0 title "Tesla GPUs, NVIDIA", \
     'data-amd.txt'       using 1:($3/$5) with linesp pt 7 ps 3.0 title "Radeon GPUs, AMD", \
     'data-intel-phi.txt' using 1:($3/$5) with linesp pt 11 ps 3.0 title "Xeon Phis, Intel"
